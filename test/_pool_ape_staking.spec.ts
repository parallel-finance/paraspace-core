...
describe("APE Coin Staking Test", () => {
  ...
  it("TC-pool-ape-staking-20 test cannot stake with HF < 1 if won't bring HF above 1 (revert expected)", async () => {
    const {
      users: [user1, depositor],
      ape,
      mayc,
  ...
  it("TC-pool-ape-staking-21 test can stake with HF < 1 if will bring HF back to above 1", async () => {
    const {
      users: [user1, depositor],
      ape,
      mayc,
