...
//   expect(name).to.be.equal("ParaSpace Testnet stable debt bearing DAI");
//   await expect(
...
//     ["mint(uint256)"](utils.parseUnits("1000", 6));
...
//     user1.signer
//   );
//   const beforeDebtBalanceUser2 = await stableDebtToken.balanceOf(
//     user2.address
//   );
...
//       )
//   );
//   const afterDebtBalanceUser1 = await stableDebtToken.balanceOf(
//     user1.address
//   );
//   const afterDebtBalanceUser2 = await stableDebtToken.balanceOf(
//     user2.address
//   );
//   // Calculate interests
...
//     ({ topics, address }) =>
//       topics[0] === transferEventSig && address == stableDebtToken.address
//   );
//   const transferAmount = stableDebtToken.interface.parseLog(
//     rawTransferEvents[0]
//   ).args.value;
//   const rawMintEvents = tx.logs.filter(
//     ({ topics, address }) =>
//       topics[0] === mintEventSig && address == stableDebtToken.address
//   );
//   const { amount: mintAmount, balanceIncrease } =
//     stableDebtToken.interface.parseLog(rawMintEvents[0]).args;
//   expect(expectedDebtIncreaseUser1.add(borrowOnBehalfAmount)).to.be.eq(
//     transferAmount
//   );
