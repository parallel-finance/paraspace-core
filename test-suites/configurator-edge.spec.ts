...
makeSuite("PoolConfigurator: Edge cases", (testEnv: TestEnv) => {
  ...
  //   await expect(
  //     configurator.updateBridgeProtocolFee(newProtocolFee)
  //   ).to.be.revertedWith(BRIDGE_PROTOCOL_FEE_INVALID);
  // });
  ...
  //     configurator
  //       .connect(poolAdmin.signer)
  //       .setEModeCategory(id, ltv, lt, lb, oracle, label)
  ...
  //     configurator
  //       .connect(poolAdmin.signer)
  //       .setAssetEModeCategory(dai.address, "100")
