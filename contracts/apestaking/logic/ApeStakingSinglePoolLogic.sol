...
library ApeStakingSinglePoolLogic {
    ...
    function stakingBAKC(
        ...
        ApeStakingCommonLogic.borrowCApeFromPool(bakcPoolState, vars, totalBorrow);
    ...
    function compoundBAKC(
        ...
        //repay and compound
        uint256 totalRepay = _calculateRepayAndCompoundBAKC(
            apePoolState,
            bakcPoolState,
            vars,
            totalReward
    ...
    function _unstakeApe(
        ...
        if (singleStakingCount > 0) {
            ...
            totalRepay += ApeStakingCommonLogic.calculateRepayAndCompound(
                apePoolState,
                vars,
                balanceDiff,
                vars.positionCap
        ...
        if (pairStakingCount > 0) {
            ...
            totalRepay += _calculateRepayAndCompoundBAKC(
                apePoolState,
                bakcPoolState,
                vars,
                balanceDiff
    ...
    function _calculateRepayAndCompoundBAKC(
        ...
        uint256 debtInterest = ApeStakingCommonLogic.calculateCurrentPositionDebtInterest(
            cApeDebtShare,
            bakcTotalPosition,
            vars.bakcMatchedCap,
            cApeExchangeRate,
