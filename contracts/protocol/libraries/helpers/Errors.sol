...
library Errors {
    ...
    string public constant MAKER_SAME_AS_TAKER = "131"; //maker and taker shouldn't be the same address
    string public constant CALLER_NOT_EOA = "132"; //The caller of the function is not an EOA account
}
