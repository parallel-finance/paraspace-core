...
interface ILendPool {
  ...
  function getReserveConfiguration(address asset) external view returns (BDaoDataTypes.ReserveConfigurationMap memory);

  function getNftConfiguration(address asset) external view returns (BDaoDataTypes.NftConfigurationMap memory);
   ...
   **/
  function getReserveData(address asset) external view returns (BDaoDataTypes.ReserveData memory);

  function getReservesList() external view returns (address[] memory);

  function getNftData(address asset) external view returns (BDaoDataTypes.NftData memory);
