  ...
  LendPoolStorageExt
{
  ...
  using ReserveConfiguration for BDaoDataTypes.ReserveConfigurationMap;
  using NftConfiguration for BDaoDataTypes.NftConfigurationMap;
  ...
  function deposit(
    ...
    SupplyLogic.executeDeposit(
      _reserves,
      BDaoDataTypes.ExecuteDepositParams({
  ...
  function withdraw(
    ...
    return
      SupplyLogic.executeWithdraw(
        _reserves,
        BDaoDataTypes.ExecuteWithdrawParams({initiator: _msgSender(), asset: asset, amount: amount, to: to})
      );
  }
  ...
  function borrow(
    ...
    BorrowLogic.executeBorrow(
      ...
      _reserves,
      _nfts,
      BDaoDataTypes.ExecuteBorrowParams({
        initiator: _msgSender(),
        asset: asset,
        amount: amount,
        nftAsset: nftAsset,
  ...
  function batchBorrow(
    ...
    BDaoDataTypes.ExecuteBatchBorrowParams memory params;
  ...
  function repay(
    ...
    return
      BorrowLogic.executeRepay(
        ...
        _reserves,
        _nfts,
        BDaoDataTypes.ExecuteRepayParams({
          initiator: _msgSender(),
          nftAsset: nftAsset,
          nftTokenId: nftTokenId,
          amount: amount
  ...
  function batchRepay(
    ...
    return
      BorrowLogic.executeBatchRepay(
        ...
        _reserves,
        _nfts,
        BDaoDataTypes.ExecuteBatchRepayParams({
          initiator: _msgSender(),
          nftAssets: nftAssets,
  ...
  function auction(
    ...
    LiquidateLogic.executeAuction(
      ...
      _nfts,
      _buildLendPoolVars(),
      BDaoDataTypes.ExecuteAuctionParams({
        initiator: _msgSender(),
        nftAsset: nftAsset,
        nftTokenId: nftTokenId,
        bidPrice: bidPrice,
  ...
  function redeem(
    ...
    return
      LiquidateLogic.executeRedeem(
        ...
        _nfts,
        _buildLendPoolVars(),
        BDaoDataTypes.ExecuteRedeemParams({
          initiator: _msgSender(),
          nftAsset: nftAsset,
          nftTokenId: nftTokenId,
          amount: amount,
  ...
  function liquidate(
    ...
    return
      LiquidateLogic.executeLiquidate(
        ...
        _nfts,
        _buildLendPoolVars(),
        BDaoDataTypes.ExecuteLiquidateParams({
          initiator: _msgSender(),
          nftAsset: nftAsset,
          nftTokenId: nftTokenId,
          amount: amount
  ...
  function getReserveConfiguration(address asset)
    ...
    view
    override
    returns (BDaoDataTypes.ReserveConfigurationMap memory)
  {
   ...
   **/
  function getNftConfiguration(address asset) external view override returns (BDaoDataTypes.NftConfigurationMap memory) {
   ...
   **/
  function getReserveData(address asset) external view override returns (BDaoDataTypes.ReserveData memory) {
   ...
   **/
  function getNftData(address asset) external view override returns (BDaoDataTypes.NftData memory) {
    return _nfts[asset];
  }
  ...
  {
    BDaoDataTypes.NftData storage nftData = _nfts[nftAsset];

    BDaoDataTypes.ReserveData storage reserveData = _reserves[reserveAsset];
    ...
    )
  {
    ...
    BDaoDataTypes.LoanData memory loan = ILendPoolLoan(_addressesProvider.getLendPoolLoan()).getLoan(loanId);
    ...
    if (loan.state == BDaoDataTypes.LoanState.Active) {
    ...
    )
  {
    ...
    if (loanId != 0) {
      BDaoDataTypes.LoanData memory loan = ILendPoolLoan(_addressesProvider.getLendPoolLoan()).getLoan(loanId);
      BDaoDataTypes.ReserveData storage reserveData = _reserves[loan.reserveAsset];
    ...
    returns (uint256 liquidatePrice, uint256 paybackAmount)
  {
    ...
    BDaoDataTypes.LoanData memory loanData = ILendPoolLoan(vars.poolLoan).getLoan(vars.loanId);

    BDaoDataTypes.ReserveData storage reserveData = _reserves[loanData.reserveAsset];
    BDaoDataTypes.NftData storage nftData = _nfts[nftAsset];
  ...
  function finalizeTransfer(
    ...
    BDaoDataTypes.ReserveData storage reserve = _reserves[asset];
  ...
  function _buildLendPoolVars() internal view returns (BDaoDataTypes.ExecuteLendPoolStates memory) {
    return BDaoDataTypes.ExecuteLendPoolStates({pauseStartTime: _pauseStartTime, pauseDurationTime: _pauseDurationTime});
  }
}
