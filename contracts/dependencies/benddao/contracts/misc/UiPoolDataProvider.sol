...
contract UiPoolDataProvider is IUiPoolDataProvider {
    ...
    returns (AggregatedReserveData[] memory)
  {
    ...
    for (uint256 i = 0; i < reserves.length; i++) {
      ...
      BDaoDataTypes.ReserveData memory baseData = lendPool.getReserveData(reserves[i]);
  ...
  function _fillReserveData(
    ...
    BDaoDataTypes.ReserveData memory baseData
  ) internal view {
    ...
    returns (AggregatedNftData[] memory)
  {
    ...
    for (uint256 i = 0; i < nfts.length; i++) {
      ...
      BDaoDataTypes.NftData memory baseData = lendPool.getNftData(nfts[i]);
  ...
  function _fillNftData(
    ...
    address nftAsset,
    BDaoDataTypes.NftData memory baseData,
  ...
  function getSimpleLoansData(
    ...
    for (uint256 i = 0; i < nftAssets.length; i++) {
      ...
      BDaoDataTypes.LoanData memory loan = poolLoan.getLoan(loanData.loanId);
