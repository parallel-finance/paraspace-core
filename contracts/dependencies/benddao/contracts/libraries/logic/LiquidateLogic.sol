...
library LiquidateLogic {
  ...
  function executeAuction(
    ...
    mapping(address => BDaoDataTypes.ReserveData) storage reservesData,
    mapping(address => BDaoDataTypes.NftData) storage nftsData,
    BDaoDataTypes.ExecuteLendPoolStates memory poolStates,
    BDaoDataTypes.ExecuteAuctionParams memory params
  ) external {
    ...
    BDaoDataTypes.LoanData memory loanData = ILendPoolLoan(vars.loanAddress).getLoan(vars.loanId);

    BDaoDataTypes.ReserveData storage reserveData = reservesData[loanData.reserveAsset];
    BDaoDataTypes.NftData storage nftData = nftsData[loanData.nftAsset];
    ...
    if (loanData.state == BDaoDataTypes.LoanState.Active) {
  ...
  function executeRedeem(
    ...
    mapping(address => BDaoDataTypes.NftData) storage nftsData,
    BDaoDataTypes.ExecuteLendPoolStates memory poolStates,
    BDaoDataTypes.ExecuteRedeemParams memory params
  ...
  function executeLiquidate(
    ...
    mapping(address => BDaoDataTypes.NftData) storage nftsData,
    BDaoDataTypes.ExecuteLendPoolStates memory poolStates,
    BDaoDataTypes.ExecuteLiquidateParams memory params
  ) external returns (uint256) {
