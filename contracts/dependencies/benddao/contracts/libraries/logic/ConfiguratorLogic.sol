...
library ConfiguratorLogic {
  ...
  function executeInitReserve(
    ...
    BDaoDataTypes.ReserveConfigurationMap memory currentConfig = cachePool.getReserveConfiguration(input.underlyingAsset);
  ...
  function executeInitNft(
    ...
    BDaoDataTypes.NftConfigurationMap memory currentConfig = pool_.getNftConfiguration(input.underlyingAsset);
  ...
  function executeUpdateBToken(ILendPool cachedPool, ConfigTypes.UpdateBTokenInput calldata input) external {
    BDaoDataTypes.ReserveData memory reserveData = cachedPool.getReserveData(input.asset);
