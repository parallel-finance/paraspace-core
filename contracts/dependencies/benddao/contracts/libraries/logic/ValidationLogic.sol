...
library ValidationLogic {
   ...
   */
  function validateDeposit(BDaoDataTypes.ReserveData storage reserve, uint256 amount) external view {
  ...
  function validateWithdraw(
    BDaoDataTypes.ReserveData storage reserveData,
    uint256 amount,
    uint256 userBalance
  ) external view {
    require(amount != 0, Errors.VL_INVALID_AMOUNT);
  ...
  function validateBorrow(
    ...
    BDaoDataTypes.ReserveData storage reserveData,
    address nftAsset,
    BDaoDataTypes.NftData storage nftData,
    address loanAddress,
    uint256 loanId,
    ...
    if (loanId != 0) {
      BDaoDataTypes.LoanData memory loanData = ILendPoolLoan(loanAddress).getLoan(loanId);

      require(loanData.state == BDaoDataTypes.LoanState.Active, Errors.LPL_INVALID_LOAN_STATE);
  ...
  function validateAuction(
    ...
    require(
      loanData.state == BDaoDataTypes.LoanState.Active || loanData.state == BDaoDataTypes.LoanState.Auction,
  ...
  function validateRedeem(
    ...
    require(loanData.state == BDaoDataTypes.LoanState.Auction, Errors.LPL_INVALID_LOAN_STATE);
   ...
   */
  function validateTransfer(address from, BDaoDataTypes.ReserveData storage reserveData) internal pure {
    from;
    reserveData;
  }
}
