...
library BorrowLogic {
  ...
  function executeBorrow(
    ...
    BDaoDataTypes.ExecuteBorrowParams memory params
  ) external {
  ...
  function _borrow(
    ...
    BDaoDataTypes.ReserveData storage reserveData = reservesData[params.asset];
    BDaoDataTypes.NftData storage nftData = nftsData[params.nftAsset];
  ...
  function executeRepay(
    ...
    mapping(address => BDaoDataTypes.ReserveData) storage reservesData,
    mapping(address => BDaoDataTypes.NftData) storage nftsData,
    BDaoDataTypes.ExecuteRepayParams memory params
  ...
  function executeBatchRepay(
    ...
    mapping(address => BDaoDataTypes.ReserveData) storage reservesData,
    mapping(address => BDaoDataTypes.NftData) storage nftsData,
    BDaoDataTypes.ExecuteBatchRepayParams memory params
