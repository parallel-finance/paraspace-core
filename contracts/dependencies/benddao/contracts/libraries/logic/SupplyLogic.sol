...
library SupplyLogic {
  ...
  function executeDeposit(
    ...
    BDaoDataTypes.ExecuteDepositParams memory params
  ) external {
    require(params.onBehalfOf != address(0), Errors.VL_INVALID_ONBEHALFOF_ADDRESS);

    BDaoDataTypes.ReserveData storage reserve = reservesData[params.asset];
  ...
  function executeWithdraw(
    mapping(address => BDaoDataTypes.ReserveData) storage reservesData,
    BDaoDataTypes.ExecuteWithdrawParams memory params
