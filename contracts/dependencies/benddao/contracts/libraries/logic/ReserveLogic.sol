...
library ReserveLogic {
   ...
   **/
  function getNormalizedIncome(BDaoDataTypes.ReserveData storage reserve) internal view returns (uint256) {
   ...
   **/
  function getNormalizedDebt(BDaoDataTypes.ReserveData storage reserve) internal view returns (uint256) {
    uint40 timestamp = reserve.lastUpdateTimestamp;
   ...
   * @param reserve the reserve object
   **/
  function updateState(BDaoDataTypes.ReserveData storage reserve) internal {
  ...
  function cumulateToLiquidityIndex(
    BDaoDataTypes.ReserveData storage reserve,
