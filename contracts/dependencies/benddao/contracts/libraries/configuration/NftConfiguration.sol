...
library NftConfiguration {
   ...
   **/
  function setLtv(BDaoDataTypes.NftConfigurationMap memory self, uint256 ltv) internal pure {
   ...
   **/
  function getLtv(BDaoDataTypes.NftConfigurationMap storage self) internal view returns (uint256) {
   ...
   **/
  function setLiquidationThreshold(BDaoDataTypes.NftConfigurationMap memory self, uint256 threshold) internal pure {
   ...
   **/
  function getLiquidationThreshold(BDaoDataTypes.NftConfigurationMap storage self) internal view returns (uint256) {
   ...
   **/
  function setLiquidationBonus(BDaoDataTypes.NftConfigurationMap memory self, uint256 bonus) internal pure {
   ...
   **/
  function getLiquidationBonus(BDaoDataTypes.NftConfigurationMap storage self) internal view returns (uint256) {
   ...
   **/
  function setActive(BDaoDataTypes.NftConfigurationMap memory self, bool active) internal pure {
   ...
   **/
  function getActive(BDaoDataTypes.NftConfigurationMap storage self) internal view returns (bool) {
   ...
   **/
  function setFrozen(BDaoDataTypes.NftConfigurationMap memory self, bool frozen) internal pure {
   ...
   **/
  function getFrozen(BDaoDataTypes.NftConfigurationMap storage self) internal view returns (bool) {
   ...
   **/
  function setRedeemDuration(BDaoDataTypes.NftConfigurationMap memory self, uint256 redeemDuration) internal pure {
   ...
   **/
  function getRedeemDuration(BDaoDataTypes.NftConfigurationMap storage self) internal view returns (uint256) {
   ...
   **/
  function setAuctionDuration(BDaoDataTypes.NftConfigurationMap memory self, uint256 auctionDuration) internal pure {
   ...
   **/
  function getAuctionDuration(BDaoDataTypes.NftConfigurationMap storage self) internal view returns (uint256) {
   ...
   **/
  function setRedeemFine(BDaoDataTypes.NftConfigurationMap memory self, uint256 redeemFine) internal pure {
   ...
   **/
  function getRedeemFine(BDaoDataTypes.NftConfigurationMap storage self) internal view returns (uint256) {
   ...
   **/
  function setRedeemThreshold(BDaoDataTypes.NftConfigurationMap memory self, uint256 redeemThreshold) internal pure {
   ...
   **/
  function getRedeemThreshold(BDaoDataTypes.NftConfigurationMap storage self) internal view returns (uint256) {
   ...
   **/
  function setMinBidFine(BDaoDataTypes.NftConfigurationMap memory self, uint256 minBidFine) internal pure {
   ...
   **/
  function getMinBidFine(BDaoDataTypes.NftConfigurationMap storage self) internal view returns (uint256) {
   ...
   **/
  function getFlags(BDaoDataTypes.NftConfigurationMap storage self) internal view returns (bool, bool) {
   ...
   * @return The state flags representing active, frozen
   **/
  function getFlagsMemory(BDaoDataTypes.NftConfigurationMap memory self) internal pure returns (bool, bool) {
   ...
   **/
  function getCollateralParams(BDaoDataTypes.NftConfigurationMap storage self)
    internal
    view
    returns (
      uint256,
   ...
   **/
  function getAuctionParams(BDaoDataTypes.NftConfigurationMap storage self)
    internal
    view
    returns (
      uint256,
   ...
   * @return The state params representing ltv, liquidation threshold, liquidation bonus
   **/
  function getCollateralParamsMemory(BDaoDataTypes.NftConfigurationMap memory self)
    internal
    pure
    returns (
      uint256,
   ...
   * @return The state params representing redeem duration, auction duration, redeem fine
   **/
  function getAuctionParamsMemory(BDaoDataTypes.NftConfigurationMap memory self)
    internal
    pure
    returns (
      uint256,
   ...
   **/
  function getMinBidFineMemory(BDaoDataTypes.NftConfigurationMap memory self) internal pure returns (uint256) {
    return ((self.data & ~MIN_BIDFINE_MASK) >> MIN_BIDFINE_START_BIT_POSITION);
  }
}
